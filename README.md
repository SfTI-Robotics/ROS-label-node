This is a fork of [instance segmentation](https://github.com/ErikGDev/instance-segmentation) based on [Facebook AI Research's](https://github.com/facebookresearch) implementation of [Mask R-CNN](https://arxiv.org/abs/1703.06870), Detectron2. This repository is used in ROS, primarily to generate labels for each pixel in an image. Detectron2 is a complete write-up from its previous version
